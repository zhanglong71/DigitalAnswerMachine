...
KEY_PLUSE	.EQU		200	;按键按下被识别,发连续脉冲的时间间隔
;-------------------------------------------------------------------------------
KEYSCAN_CHK:
;---------------
INT_KEYOUT:
...
INT_KEYOUT_30:			;scan the 3rd(GPAD.9---KEY3..0)
        ...
        ADHK	0
        BS	B1,INT_KEYOUT_END
INT_KEYOUT_20:			;scan the 2nd(GPAD.10---KEY7..4)
	...
	LAC	INT_TTMP1
        ...
        ADHK	0
	BS	B1,INT_KEYOUT_END      
INT_KEYOUT_10:			;scan the 1st(GPAD.11---KEY11..8)
...
INT_KEYIN_30:
	...
	BZ	ACZ,INT_KEYIN_20
        ...
        OR	INT_TTMP1
        SAH	KEY
	BS	B1,INT_KEYIN_END	;SAVE the 3rd key set in KEY(3..0)
