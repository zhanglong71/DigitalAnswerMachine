...
LOCAL_PRO1BOOK_0:
	...
	LAC	MSG
	XORL	CBOOK_SLET
	BS	ACZ,LOCAL_PRO1BOOK_1_0_MENU		;Goto option select(search)
	LAC	MSG
	XORL	CBOOK_FLT
	BS	ACZ,LOCAL_PRO1BOOK_SLCT
...
;!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	RET
;-------------------------------------------------------------------------------
LOCAL_PRO1BOOK_1:	;选择添加或查找
	LAC	PRO_VAR
	SFR	4
	ANDK	0X0F
	BS	ACZ,LOCAL_PRO1BOOK_1_0
	SBHK	1
	BS	ACZ,LOCAL_PRO1BOOK_1_1
...
;!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	LAC	VOP_FG
	ANDL	0XCFFF
	ORL	0X2000		;Specific filter-number
	SAH	VOP_FG
;!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
.if	0	
	LAC	MSG_N
...
;LOCAL_PROBOOK1_2_0_5:
	LAC	MSG
	XORL	CMSG_KEY4S
	BS	ACZ,LOCAL_PRO1BOOK_2_PLAY	;PLAY(Goto edit)
...
;!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	RET
;---------------------------------------
LOCAL_PRO1BOOK_2_PLAY:		;翻查电话本时进入编辑状态
	LAC	MSG_ID
...
.if	0
	...
	SAH	PRO_VAR
.else
	;BS	B1,LOCAL_PRO1BOOK_SLCT
	BS	B1,LOCAL_PRO1BOOK_1_0_MENU
.endif	
	RET
;-------------------------------------------------------------------------------
.INCLUDE l_tel.asm
