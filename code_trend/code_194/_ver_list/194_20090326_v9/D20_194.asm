...
;		bit1=	1/0---caller id valid/caller id invalid(来铃失败/退出应答/应答密码PASS清除,收到来电信息时置位)
...
;		bit14 =	1/0------New VIP-CID exist/not(for BeepVOP)
...
DAA_REC:	;(SW0) ==> (MIC->ADC)
	...
	NOP
	OUTL	(CMIC_PRE_GAIN<<8)|(0X07<<4),AGC
;---
	OUTK	0,ANAPWR	;all power on
	RET
...
.DATA	0X00	0X03	0X06	0X0A	0X0D	0X10	0X13	0X17	0X19
