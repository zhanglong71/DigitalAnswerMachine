...
LOCAL_PROCID:		;翻查来电状态要考虑的消息
	...
	LAC	MSG
	XORL	CMSG_KEY2S
	BS	ACZ,LOCAL_PROCID_EXIT	;OGM
	
	LAC	MSG
	XORL	CMSG_KEY2L
	BS	ACZ,LOCAL_PROCID_EXIT	;OGM_
	
	LAC	MSG
	XORL	CMSG_KEY4S
	BS	ACZ,LOCAL_PROCID_EXIT	;PLAY
...
LOCAL_PROCID_0:
	LAC	MSG
	XORL	CMSG_KEY5S
	BS	ACZ,LOCAL_PROCID_0_INCOMECALL
	LAC	MSG
	XORL	CMSG_KEY9S
	BS	ACZ,LOCAL_PROCID_0_INCOMECALL
;---
...
;LOCAL_PROCID_1_6:
	LAC	MSG
	XORL	CMSG_KEY3S
	BS	ACZ,LOCAL_PROCID_1_TIME	;号码提取
;LOCAL_PROCID_1_7:
	LAC	MSG
	XORL	CMSG_KEY7S
...
MAIN_PRO6_0_0_TMR:
	...
	RET
;---------------------------------------
LOCAL_PROCID_1_TIME:		;此处的地址引用参照电话本部分
	LAC	MSG_ID
...
LOCAL_PROCID_3_ERASE:
	...
	SFR	4
	ANDK	0X0F
	BS	ACZ,MAIN_PRO6_2_0
	SBHK	1
	BS	ACZ,MAIN_PRO6_2_1	;Delete current tel-num
	SBHK	1
	BS	ACZ,MAIN_PRO6_2_2	;wait for key-released
	SBHK	1
	BS	ACZ,MAIN_PRO6_2_3	;Delete all tel-num
	
	RET
;-------------------------------------------------------------------------------
MAIN_PRO6_2_0:		;Reserved
