...
;---
	LIPK	0
        IN	INT_TTMP1,IPTR
        BIT	INT_TTMP1,4		;check if the ring detector is low ?
...
;---持续低的时间不大于规定时间
	LIPK    0 
        IN      INT_TTMP1,IPTR
        BIT     INT_TTMP1,4		;check if the ring detector is still low ?
...
;---持续高的时间不大于规定时间
	LIPK    0
        IN      INT_TTMP1,IPTR
        BIT     INT_TTMP1,4           	;check if the ring detector is still high
