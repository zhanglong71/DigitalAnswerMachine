...
ICM_STATE_INIT:
	...
	LAC	VOP_FG
	ANDL	~(1<<14)
	SAH	VOP_FG		;clear last VIP-CID flag
...
ICM_STATE_INIT_DEFOGM:		;播默认的语音()
	...
	ANDK	0X0F
	SBHK	5
	;BS	ACZ,ICM_STATE_INIT_EXIT		;OGM5无Default VOP
...
ANS_STATE_REC_DTMF:
	...
	SBHK	1
	BS	ACZ,ANS_STATE_REC_DTMFMBOX1_YES
	SBHK	1
	BS	ACZ,ANS_STATE_REC_DTMFMBOX2_YES
	SBHK	1
	BS	ACZ,ANS_STATE_REC_DTMFMBOX3_YES
	SBHK	1
	BS	ACZ,ANS_STATE_REC_DTMFMBOX4_YES
...
;---------------------------------------
ANS_STATE_REC_DTMFMBOX1_YES:
	LACK	1
	SAH	MBOX_ID
	BS	B1,ANS_STATE_REC_CHANGEMBOX
ANS_STATE_REC_DTMFMBOX2_YES:
	LACK	2
	SAH	MBOX_ID
	BS	B1,ANS_STATE_REC_CHANGEMBOX
ANS_STATE_REC_DTMFMBOX3_YES:
	LACK	3
	SAH	MBOX_ID
	BS	B1,ANS_STATE_REC_CHANGEMBOX
ANS_STATE_REC_DTMFMBOX4_YES:
	LACK	4
	SAH	MBOX_ID
	BS	B1,ANS_STATE_REC_CHANGEMBOX
ANS_STATE_REC_CHANGEMBOX:
	LAC	CONF		;若是录音过程,则删除之
	ORL	1<<11
	CALL	DAM_BIOSFUNC
	CALL	INIT_DAM_FUNC
	CALL	DAA_ANS_SPK
