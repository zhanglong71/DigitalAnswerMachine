...
;*or
;*When edit CID-number end and find the TEL-data that the number same as the number you enter, respone "CNAME_EDIT"(As the same TEL-number find)
;*or
...
;---读出TEL数据
	...
	LAC	MSG_ID		;MSG_ID
	CALL	READ_TELNUM	;read the TEL specific with MSG_ID
	CALL	STOPREADDAT
;---发送TEL数据
	LACL	TEL_RAM
	SAH	ADDR_S
...
MAIN_PRO10_2_1_MENU_0:		;如果最后值是无效字符(大于0x24 or 小于0)则长度减1
	LAC	FILE_LEN
	SBHL	0X0100
	SAH	FILE_LEN
	ANDL	0X1F00
