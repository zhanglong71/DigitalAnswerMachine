...
OGM_STATUS1:
	...
	LAC	MSG_N
	ANDK	0X07		;1..5 => 0XD009.0XD00A/0XD00B
	ADHL	0XD008
	CALL	DAM_BIOSFUNC
	LACL	0XD202
	CALL	DAM_BIOSFUNC
...
;	从以ADDR_S为起始地址以OFFSET_S为offset的队列取数据(一个字节)
...
;	将数据存在以ADDR_D为起始地址以OFFSET_D为offset的空间(一个字节)
