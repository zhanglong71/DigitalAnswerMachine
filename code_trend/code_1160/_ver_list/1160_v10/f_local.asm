...
;LOCAL_PRO_0_15:
	LAC	MSG
	XORL	CBOOK_SLET	;End edit(edit name)Add phone-name end and return to phonebook select
	BS	ACZ,MAIN_PRO0_SELECTBOOK
	LAC	MSG
	XORL	CSTOR_TYPE	;Going to select TEL type(Normal/VIP/Filter)
	BS	ACZ,MAIN_PRO0_SELECTTYPE
	;LAC	MSG
	;XORL	CLOOK_ATEL	;edit(edit name)Add phone-name end and return to phonebook select
	;BS	ACZ,MAIN_PRO0_LOOKBOOK
;LOCAL_PRO_0_15:
	LAC	MSG
...
MAIN_PRO0_RING:
	...
	BIT	VOP_FG,14		;VIP-CID
	BZ	TB,MAIN_PRO0_RING_CHKEND	;Not VIP-CID
		
	CALL	DAA_SPK
	CALL	RBEEP
	
MAIN_PRO0_RING_CHKEND:
...
MAIN_PRO0_TMR_60s:
	LAC	ANN_FG
	ANDL	0X00E0
	BZ	ACZ,MAIN_PRO0_TMR_BEEPVP	;New ICM(Mbox1,2,3)
	BIT	VOP_FG,10
	BS	TB,MAIN_PRO0_TMR_BEEPVP		;New ICM(Mbox4)
	;BIT	VOP_FG,14			;Check New VIP-CID exist
	;BS	TB,MAIN_PRO0_TMR_BEEPVP
	BS	B1,MAIN_PRO0_TMR_END
