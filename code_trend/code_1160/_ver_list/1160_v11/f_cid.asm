...
LOCAL_PROCID_0:
	...
	LAC	MSG
	XORL	CMSG_CID
	BS	ACZ,LOCAL_PROCID_0_CID	;Received new CID
	LAC	MSG
	XORL	CRING_IN
...
;---Get flag-num	
	...
	LACK	4	;First offset of tel-num
	SAH	OFFSET_S
	LACK	0
	SAH	MSG_ID		;序号
	...
	BIT	VOP_FG,14
	BS	TB,LOCAL_PROCID_0_CIDRING
	bs	b1,LOCAL_PROCID_0_CIDRING	;No CID announce function
;LOCAL_PROCID_0_CID_END:
	CALL	INIT_DAM_FUNC
	CALL	DAA_SPK
	LACK	0X005
	CALL	STOR_VP
	...
	RET
;---------------------------------------
LOCAL_PROCID_0_CIDRING:		;VIP-CID
	CALL	INIT_DAM_FUNC
	CALL	DAA_SPK
	LACK	0X05
	CALL	STOR_VP
...
;!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	RET
;-------------------------------------------------------------------------------
LOCAL_PROCID_X_RINGIN:		;Note:Don`t exit while announce CID number
	CALL	INIT_DAM_FUNC
	LACK	0
	SAH	PRO_VAR
	CALL	BLED_ON
