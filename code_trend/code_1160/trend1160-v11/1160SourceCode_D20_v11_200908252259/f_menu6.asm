...
LOCAL_PROMENU6:				;MENU设置状态要考虑的消息(PRO_VAR)
	...
	LAC	PRO_VAR
	ANDK	0X0F
	BS	ACZ,LOCAL_PROMENU6_0	;
	SBHK	1
	BS	ACZ,LOCAL_PROMENU6_1	;ring change
	SBHK	1
	BS	ACZ,LOCAL_PROMENU6_2	;end and goto next menu
	SBHK	1
	BS	ACZ,LOCAL_PROMENU6_3	;end and exit
...
MAIN_PRO9_5_1_REW:
	...
	SAH	MSG_N
	SBHK	1
	BS	ACZ,MAIN_PRO9_5_1_X_TOLLSAVER
...
MAIN_PRO9_5_1_X_TOLLSAVER:
	LACL	0XFF00|VOP_INDEX_TollSaver
	CALL	STOR_VP
	BS	B1,MAIN_PRO9_5_X_SENDCOMM
MAIN_PRO9_5_1_PREW:
	LACK	1
