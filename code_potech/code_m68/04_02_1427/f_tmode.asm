...
LOCAL_PROTXT:			;PRO_VAR = 0Xyyy7
	...
	SBHK	1
	BS	ACZ,LOCAL_PROTESTB	;memory test
...
;---	
	LAC	MSG
	XORL	CTMODE_PVOP		;play BEEP to line
	BS	ACZ,LOCAL_PROTEST0_PLYVOP
	
	LAC	MSG
	XORL	CTMODE_PBEEP		;play BEEP to line
	BS	ACZ,LOCAL_PROTEST0_PLYBEEP
;---	
	LAC	MSG
...
;---	
	...
	LAC	MSG
	XORL	CTMODE_RESVED		;reserved command
	BS	ACZ,LOCAL_PROTEST0_RESERVED
...
LOCAL_PROTESTA_TMR:
	...
	SAH	DTMF_VAL
	SBHK	10
	BS	SGN,LOCAL_PROTESTA_TMR_1	;0..9
	BS	ACZ,LOCAL_PROTESTA_TMR_A	;A
	SBHK	1
	BS	ACZ,LOCAL_PROTESTA_TMR_B	;B
	SBHK	1
	BS	ACZ,LOCAL_PROTESTA_TMR_C	;C
	SBHK	1
	BS	ACZ,LOCAL_PROTESTA_TMR_D	;D
	SBHK	1
	BS	ACZ,LOCAL_PROTESTA_TMR_STAR	;*
	SBHK	1
	BS	ACZ,LOCAL_PROTESTA_TMR_POUND	;#
	
LOCAL_PROTESTA_TMR_A:		;A
	LACK	0X41
	SAH	DTMF_VAL
	BS	B1,LOCAL_PROTESTA_TMR_ABCDSP
LOCAL_PROTESTA_TMR_B:		;B	
	LACK	0X42
	SAH	DTMF_VAL
	BS	B1,LOCAL_PROTESTA_TMR_ABCDSP
LOCAL_PROTESTA_TMR_C:		;C
	LACK	0X43
	SAH	DTMF_VAL
	BS	B1,LOCAL_PROTESTA_TMR_ABCDSP
LOCAL_PROTESTA_TMR_D:		;D
	LACK	0X44
	SAH	DTMF_VAL
	BS	B1,LOCAL_PROTESTA_TMR_ABCDSP
LOCAL_PROTESTA_TMR_STAR:	;*
	LACK	0X2A
	SAH	DTMF_VAL
	BS	B1,LOCAL_PROTESTA_TMR_ABCDSP	
LOCAL_PROTESTA_TMR_POUND:	;#
	LACK	0X23
	SAH	DTMF_VAL
	;BS	B1,LOCAL_PROTESTA_TMR_ABCDSP	
LOCAL_PROTESTA_TMR_ABCDSP:	
	LACK	0X1d
	CALL	SEND_DAT
	LACL	0X80
	CALL	SEND_DAT
...
LOCAL_PROTESTB:
	LAC	MSG
	XORL	CMSG_TMR		;TMR
	BS	ACZ,LOCAL_PROTESTB_TMR	
	
	LAC	MSG
	XORL	CTMODE_STOP		;STOP
	BS	ACZ,LOCAL_PROTESTB_EXIT	
