...
REMOTE_PRO1_PLAY_OVER:
	...
	ANDL	0X0FF
	SBHK	1
	BS	ACZ,REMOTE_PRO1_REV_DTMF_POUND
	BS	SGN,REMOTE_PRO1_REV_DTMF_POUND
REMOTE_PRO1_PLAY_OVER1:
	...
	CALL	REW_MANAGE	
	BZ	ACZ,REMOTE_PRO1_REV_DTMF_POUND	;没新的了
...
REMOTE_PRO1_REV_DTMF:
	...
	SBHK	8
	BS	ACZ,REMOTE_PRO1_REV_DTMF_STAR	;*
	SBHK	1
	BS	ACZ,REMOTE_PRO1_REV_DTMF_POUND	;#
	RET
...
REMOTE_PRO1_REV_DTMF_6:
	...
	RET
REMOTE_PRO1_REV_DTMF_STAR:
REMOTE_PRO2_REV_DTMF_STAR:
	LAC	CONF
	ORL	0X0100
	SAH	CONF
	CALL	DAM_BIOS
...
REMOTE_PRO2_PLAY_OVER:
	...
	ANDL	0X0FF
	SBHK	1
	BS	ACZ,REMOTE_PRO2_REV_DTMF_POUND
	BS	SGN,REMOTE_PRO2_REV_DTMF_POUND
...
REMOTE_PRO2_REV_DTMF:
	...
	SBHK	8
	BS	ACZ,REMOTE_PRO2_REV_DTMF_STAR	;*
	SBHK	1
	BS	ACZ,REMOTE_PRO2_REV_DTMF_POUND	;#
	RET
...
REMOTE_PRO1_REV_DTMF_POUND:
REMOTE_PRO2_REV_DTMF_POUND:
	CALL	INIT_DAM_FUNC
...
REMOTE_PRO7:
	...
	SBHK	1
	BS	ACZ,REMOTE_PRO7_1	;play voice prompt
	SBHK	1
...
REMOTE_PRO7_RECORD_TIMER:
	...
	SBHK	120
	BS	SGN,REMOTE_PRO7_RECORD_TIMER_END
	
	BS	B1,REMOTE_PRO7_RECORD_DTMF_1
...
REMOTE_PRO8_2:	;---不让产生VOX,BTONE,CTONE消息
...
REMOTE_PRO8_TIMER:
	...
	SAH	PRO_VAR1
	SBHK	30
	BS	SGN,REMOTE_PRO8_TIMER_END	;30s计时
	BS	ACZ,REMOTE_PRO8_REV_DTMF_POUND
	BS	B1,REMOTE_PRO8_REV_DTMF_POUND
