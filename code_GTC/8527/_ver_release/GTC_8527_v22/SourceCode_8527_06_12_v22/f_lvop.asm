...
LOCAL_PROCIDVP_RING:
	...
	SBHK	1
	BS	ACZ,LOCAL_PROLVOP_END4	;(0x0410 - must 0x2f command)
...
LOCAL_PRO0_KEYVOP_LANGVOP:
	...
	LAC	ERR_FG
	ORK	1<<2
	SAH	ERR_FG		;Update volum in flash
...
LOCAL_PROCIDVP_SER:
	CALL	TESTGETR_DAT
	XORL	0X80
	BS	ACZ,LOCAL_PROKEYVP_SER_0X80ATT	;TEST 0X80 first
...
LOCAL_PROCIDVP_VPSTOP:
	...
	LACK	ADDR_BUF	;set base address
	SAH	ADDR_S
...
LOCAL_PROCIDVP_CIDVP:
	...
	SAH	ADDR_S
	LACK	ADDR_BUF	;the destination base address
	SAH	ADDR_D
	LACK	6
	CALL	MOVE_DAT
