...
.EXTERN	SYS_SER_RUN_0X80
.EXTERN	SYS_SER_RUN_0X81
.EXTERN	SYS_SER_RUN_0X82
.EXTERN	SYS_SER_RUN_0X83
;-------------------------------------------------------------------------------
.LIST
;-------------------------------------------------------------------------------
.ORG	ADDR_SECOND
...
;---------------	
	...
	SBHK	0X10
	BS	SGN,LOCAL_PROPHO_SER_END	;0x70<= x <0x80
	SBHK	0X10
...
;---------------------------------------
COMMAND0X800X90_TAB:
.data	SYS_SER_RUN_0X80
.data	SYS_SER_RUN_0X81
.data	SYS_SER_RUN_0X82
.data	SYS_SER_RUN_0X83
...
;---
	...
	LAC	MSG
	SBHL	0X84
	BZ	SGN,LOCAL_PROPHO_SER_0X8090_END		;0x84<= x --

	LAC	MSG
	SBHL	0x80
	ADHL	COMMAND0X800X90_TAB
	CALL	GetOneConst
	ADHK	0
	CALA		;call to ...	
LOCAL_PROPHO_SER_0X8090_END:
;---
	POP	CONF
...
;!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	LAC	ANN_FG
	ANDL	~(1<<9)
	SAH	ANN_FG		;reset ReviewCID flag
