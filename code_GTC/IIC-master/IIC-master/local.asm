...
LOCAL_PRO0_1_1:
	LAC	MSG
	XORL	CMSG_KEY1L		;Record message
	BS	ACZ,LOCAL_PRO0_RECMSG
LOCAL_PRO0_2:
	LAC	MSG
	XORL	CMSG_KEY2S		;FPLY ON
	BS	ACZ,LOCAL_PRO0_FPLYON
LOCAL_PRO0_3:
	LAC	MSG
	XORL	CMSG_KEY3S		;FPLY OFF
	BS	ACZ,LOCAL_PRO0_FPLYOFF
LOCAL_PRO0_4:
	LAC	MSG
	XORL	CMSG_KEY4S		;speakerphone On
	BS	ACZ,LOCAL_PRO0_PHOON
LOCAL_PRO0_5:
	LAC	MSG
...
;---
	...
	CALL	SLAVE_ACK
	LACL	0X07
	CALL	SEND_BYTE	;Byte1
	CALL	SLAVE_ACK
	LACL	0X55
	CALL	SEND_BYTE	;Byte2
	CALL	SLAVE_ACK
	LACL	0X83
	CALL	SEND_BYTE	;Byte3
	CALL	SLAVE_ACK
	LACL	0X04
	CALL	SEND_BYTE	;Byte4
	CALL	SLAVE_ACK
	LACL	0X87
	CALL	SEND_BYTE	;Byte5
	CALL	SLAVE_ACK
	LACL	0X50
	CALL	SEND_BYTE	;Byte6
	CALL	SLAVE_ACK
	LACL	0X12
	CALL	SEND_BYTE	;Byte7
	CALL	SLAVE_ACK
	LACL	0X34
	CALL	SEND_BYTE	;Byte8
	CALL	SLAVE_ACK
	CALL	IIC_STOP
;---	
	EINT
