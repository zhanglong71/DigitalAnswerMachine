...
RING_HI_CHK:
	...
	LIPK    8
        ...
        LAC     RING_ID
        ANDL    0XF0FF
        ORL     0X400             	;set in ring off state
        SAH     RING_ID

        LACL    500               	;500 ms for min. ring off time
        SAH     TMR3
        BS      B1,RING_CHK_END
;-------------------------------------------------------------------------------
RING_OFF_CHK:
	LIPK    8
        ...
        LACL    500               	;if ring detector changes to low, restore
...
RING_OFF_CHK2:
        ...
        LACL    8000              	;TMR3=8.0 sec for max. ring wait time
        SAH     TMR3
                                  	;one ring ok
        LAC     RING_ID
        ANDL    0XFF
        ADHK    0X10
        ORL     0X800             	;set in ring wait state
        SAH     RING_ID
