...
;-------------------
	...
	SBHK	0X01
	BS	ACZ,ANS_STATE_SER_0X4B	;(0X4B)HF-vol
;---
	LAC	MSG
	SBHK	0X5A
...
ANS_STATE_SER_0X4A:		;set Volume
	...
	RET
;---------------------------------------
ANS_STATE_SER_0X4B:		;not in spkphone mode set Speakerphone volume (GTC demand;2009-6-30 20:42)
	LAC	VOI_ATT
	ANDL	0XFF0F
	SAH	VOI_ATT
...
ANS_STATE_INIT4:		;full
	...
	RET
;---------------------------------------
ANS_STATE_INIT5:		;run timer before play help message
	CALL	INIT_DAM_FUNC
	LACK	0X0020
	SAH	PRO_VAR
