...
LOCAL_PROOGM_SER_0X6070:
	...
	SBHK	0X02
	BS	ACZ,LOCAL_PROOGM_0x65	;(0x65)Play Help
	SBHK	0X01
	BS	ACZ,LOCAL_PROOGM_0x66	;(0x62)Record Help
	SBHK	0X01
	BS	ACZ,LOCAL_PROOGM_0x67	;(0x63)normal playspeed
...
LOCAL_PROOGM_PSANORAMAL:
	...
	RET
;---------------------------------------
LOCAL_PROOGM_0x65:	;play help
	LACL	CPLY_HELP
	CALL	STOR_MSG
	
	RET
LOCAL_PROOGM_0x66:	;record help
	LACL	CREC_HELP
	CALL	STOR_MSG
...
LOCAL_PROOGM_IDLE:
	...
	LAC	MSG
	XORL	CPLY_HELP		;play Help
	BS	ACZ,LOCAL_PROHLP_IDLEPLY
	LAC	MSG
	XORL	CREC_HELP		;record Help
	BS	ACZ,LOCAL_PROHLP_IDLEREC
	
	RET
;---------------------------------------
LOCAL_PROHLP_IDLEPLY:
	LAC	ANN_FG
	ORL	(1<<9)
	SAH	ANN_FG
	BS	B1,LOCAL_PRO_IDLEPLY
;---------------------------------------
...
LOCAL_PROHELP_IDLEPLY_1:
	...
	RET
;---------------------------------------
LOCAL_PROHLP_IDLEREC:
	LAC	ANN_FG
	ORL	(1<<9)
	SAH	ANN_FG
	BS	B1,LOCAL_PRO_IDLEREC
...
LOCAL_PROOGM_PLYVOP:
	LAC	MSG
	XORL	CMSG_KEY5S
	BS	ACZ,LOCAL_PROOGM_PLYVOP_STOP	;REC stop AND PLAY OGM
	LAC	MSG
	XORL	CPLY_HELP
	BS	ACZ,LOCAL_PROOGM_PLYVOP_STOP	;REC stop AND PLAY HLP
...
LOCAL_PROOGM_PLYVOP_STOP:
	...
	BIT	ANN_FG,9
	BS	TB,LOCAL_PROOGM_PLYVOP_STOP_1
