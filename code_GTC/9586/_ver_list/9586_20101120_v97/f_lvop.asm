...
LOCAL_PROALARM:
	...
	SFR	8
	ANDK	0X0F
	BS	ACZ,LOCAL_PROALARM_0	;0 = idel
	SBHK	1
	BS	ACZ,LOCAL_PROALARM_1	;1 = play smoke alarm
	SBHK	1
	BS	ACZ,LOCAL_PROALARM_2	;2 = play switch alarm
	SBHK	1
	BS	ACZ,LOCAL_PROALARM_3	;3 = play Door bell
...
LOCAL_PROALARM_0:		
	...
	CALL	GET_MSG
	BS	ACZ,LOCAL_PROALARM_END
	SAH	MSG
;-------------------------------------------------------------------------------	
	LAC	MSG
	XORL	CMSG_KEY6S		;stop
	BS	ACZ,LOCAL_PROALARM_ALMSTOP
	LAC	MSG
	XORL	CRING_IN		;ring
	...
	BS	ACZ,LOCAL_PROSMK_SMKALM
	LAC	MSG
	XORL	CPLY_SWALM		;play switch alarm
	BS	ACZ,LOCAL_PROSWH_SWHALM
	LAC	MSG
	XORL	CPLY_DBELL		;play Door bell
	BS	ACZ,LOCAL_PRODOR_DORBEL

LOCAL_PROALARM_END:
	RET
;---------------------------------------
LOCAL_PROSMK_SMKALM:
LOCAL_PROALARM_1_VPSTOP:	;no stop, vop end then start again
	LACL	0X0140
	SAH	PRO_VAR
...
;---------------------------------------	
	...
	LAC	MSG
	XORL	CVP_STOP
	BS	ACZ,LOCAL_PROALARM_1_VPSTOP	;VP stop, then start again
...
.INCLUDE	l_CodecPath/l_setvol.asm
