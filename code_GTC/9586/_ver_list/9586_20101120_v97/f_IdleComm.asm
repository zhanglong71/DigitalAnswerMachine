...
SYS_SER_RUN_0X6070:
	...
	SBHK	0X01
	BS	ACZ,SYS_SER_RUN_0X65	;Play Help message
	SBHK	0X01
	BS	ACZ,SYS_SER_RUN_0X66	;Record Help message
	SBHK	0X01
	BS	ACZ,SYS_SER_RUN_0X67	;Goto help mode
	SBHK	0X01
	BS	ACZ,SYS_SER_RUN_0X68	;Play smoke alarm
	SBHK	0X01
	BS	ACZ,SYS_SER_RUN_0X69	;Door switch alarm
	SBHK	0X01
...
SYS_SER_RUN_0X7080:
	...
	SBHK	0X01
	BS	ACZ,SYS_SER_RUN_0X71	;Door bell
	SBHK	0X01
...
;---------------
SYS_SER_RUN_0X65:
	LACL	CPLY_HELP	;play help message
	CALL	STOR_MSG
	BS	B1,SYS_MSG_YES
;---------------
SYS_SER_RUN_0X66:
	LACL	CREC_HELP	;Record help message
	CALL	STOR_MSG
	BS	B1,SYS_MSG_YES
;---------------
SYS_SER_RUN_0X67:
	LACL	CHMOD_OK	;Goto help mode(play help message 3 times)
	CALL	STOR_MSG
	BS	B1,SYS_MSG_YES
;---------------
SYS_SER_RUN_0X68:
	LACL	CPLY_SMALM	;Play smoke alarm
	CALL	STOR_MSG
	BS	B1,SYS_MSG_YES
;---------------
SYS_SER_RUN_0X69:
	LACL	CPLY_SWALM	;play switch alarm
	CALL	STOR_MSG
	BS	B1,SYS_MSG_YES
;---------------
SYS_SER_RUN_0X6A:
...
SYS_SER_RUN_0X700X01:
	...
	BS	B1,SYS_MSG_YES
;---------------------------------------
SYS_SER_RUN_0X71:	;Door bell

	LACL	CPLY_DBELL	;play switch alarm
	CALL	STOR_MSG
	BS	B1,SYS_MSG_YES
;---------------
